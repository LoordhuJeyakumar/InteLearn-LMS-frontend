            ...
            <div className="w-[30%] flex flex-col gap-3 lg:w-[30%] mb-7 lg:pl-0">
              <div className="w-full">
                <div className="flex items-center space-x-2 p-4">
                  <div className="w-6 h-6 bg-gradient-to-r from-yellow-25 to-purple-600 rounded-full flex items-center justify-center">
                    <span className="text-black text-lg font-extrabold">I</span>
                  </div>
                  <h1 className="text-base font-extrabold text-gray-800">
                    <span className="text-yellow-25">Inte</span>
        ...
        <div className="flex justify-between lg:items-start items-center flex-col lg:flex-row gap-3 w-full">
          ...
          <div className="text-center flex flex-col sm:flex-row ">
            <div className="flex ">
              ...
              <Link
                to="https://github.com/loordhujeyakumar"
                target="__blank"
            ...
            <span> © {new Date().getFullYear()} Intelearn</span>
          </div>
          ...
          <div className="flex items-center">
            ...
            <a
              href="https://www.github.com/loordhujeyakumar"
              className="text-white p-3 hover:bg-richblack-700 rounded-full duration-300"
              target="_blank"
              rel="noopener noreferrer"
            >
