      ...
      <div className="flex w-11/12 max-w-maxContent items-center justify-between ">
        ...
        <Link to="/">
          <div className="flex items-center space-x-2 p-4">
            <div className="w-10 h-10 bg-gradient-to-r from-yellow-25 to-purple-600 rounded-full flex items-center justify-center">
              <span className="text-black text-xl font-extrabold">I</span>
            </div>
